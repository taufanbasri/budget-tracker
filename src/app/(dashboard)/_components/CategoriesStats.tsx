...
function CategoryCard({
    ...
    return (
        <Card className='flex h-80 w-full col-span-6 flex-col'>
            <CardHeader>
                                            ...
                                            >
                                                <div className="flex items-center justify-between">
                                                    <span className="flex items-center text-gray-400">
                                                        ...
                                                        <span className="ml-2 text-start text-muted-foreground">
                                                ...
                                                <Progress
                                                    value={percentage}
                                                    indicatorColor={type === 'income' ? 'bg-emerald-500' : 'bg-red-500'}
                                                />
                                            </div>
                                        )
                                    })
