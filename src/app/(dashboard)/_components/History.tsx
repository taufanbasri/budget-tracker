...
const History = ({ userSettings }: Props) => {
    ...
    const historyDataQuery = useQuery({
        ...
        queryFn: async () => fetch(`/api/history-data?timeframe=${timeframe}&year=${period.year}&month=${period.month}`).then(res => res.json()),
    })
...
function TooltipRow({
    ...
    label: string, value: number, bgColor: string, textColor: string, formatter: Intl.NumberFormat
}) {
